...
<div class="right-center-wrapper">
    <div class="card" style="width: 30rem; height: 30rem;">
        <div class="card-body">
            <h5 class="card-title">Find Email</h5>
            <h6 class="card-subtitle mb-2 text-muted">Find Your Account</h6>
            <br>
            <!------------------ Sing in from--------- -->
            <form action="forgotpassword" onsubmit="return singInValidation(event)" method="GET">
                <div class="mb-3">
                    <label for="floatingInput" class="form-label">Email ID</label>
                    <input type="email" class="form-control" id="floatingInput" name="emailName" placeholder="Enter your Email to find your account" aria-describedby="emailHelp">
